Implementation of an anonymous and completely decentralized P2P file storage system, based on freenet (https://freenetproject.org/index.html) and other similar systems.
Components:
